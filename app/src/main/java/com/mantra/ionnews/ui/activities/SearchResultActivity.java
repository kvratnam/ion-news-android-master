...
public class SearchResultActivity extends BaseActivity
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setFlipView();
        fetchStory(Integer.parseInt(categoryId));
    ...
    private void fetchStory(final int page) {
        if (Util.hasInternetAccess(this)) {
            SearchResultHandler categoryStoryDataHandler = new SearchResultHandler(this, getApplicationContext());
            categoryStoryDataHandler.request(LocalStorage.getInstance(getApplicationContext()).getID(), page);
        } else {
